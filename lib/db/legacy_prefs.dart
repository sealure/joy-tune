...
// ─────────────────────────────────────────────────────────────────────────────
// 旧版 SharedPreferences 存储（SQLite 迁移前的历史实现）
//
// 用途：① LegacyPrefsMigrator 启动时读取旧数据迁入 SQLite；
//      ② 迁移完成前，搜索历史/播放会话等消费方暂时依赖本类。
// 迁移完成后本文件应删除。
// ─────────────────────────────────────────────────────────────────────────────
...
const _playSessionKey = 'play_session';
const _maxSearchHistory = 20;

/// 旧版本地存储工具（SharedPreferences 实现）
class LegacyPrefs {
